...
import { Sun, Cloud, CloudRain, CloudDrizzle, CloudSnow, CloudLightning, CloudFog, CloudSun, Wind, Droplets, Thermometer, MapPin, RefreshCw, Navigation } from 'lucide-react';
